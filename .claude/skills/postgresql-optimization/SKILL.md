...
Expert PostgreSQL guidance for the code currently in scope (or the whole project, when nothing specific is in scope). Focus on PostgreSQL-specific features, optimization patterns, and advanced capabilities.
